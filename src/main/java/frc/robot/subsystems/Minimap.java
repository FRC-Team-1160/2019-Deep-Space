 ...
 **********************************************************************/
 ...
 static void updatePosition() { 
    ...
    double changeXVelocity = xValue * timeValue * timeValue;
    double changeYVelocity = yValue * timeValue * timeValue;
    double changeZVelocity = zValue * timeValue * timeValue;
    ...
    /*TL;DR: save velocity into the coordinates - this works because 
      ...
      TL;DR 2: This probably doesn't work, just multiply by time twice lol
    */
